...
class JWTHandler:
    ...
    def __init__(
        ...
        if not hasattr(self, 'secret_key'):
            self.secret_key = secret_key or os.getenv("JWT_SECRET_KEY", "default-test-secret-key-for-development")
    ...
    def analyze_token(self, token: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "time_to_expiry_seconds": time_to_expiry.total_seconds() if time_to_expiry else None,
...
sample_jwt_token = lambda: "sample_token_deprecated"  # 테스트용 deprecated
