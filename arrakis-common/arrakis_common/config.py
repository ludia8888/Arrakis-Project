...
try:
    ...
    try:
        ...
        # Create a minimal BaseSettings if neither is available
...
class JWTSettings(BaseSettings):
    ...
    jwt_public_key_base64: Optional[str] = Field(default=None, env="JWT_PUBLIC_KEY_BASE64")
    jwt_private_key_base64: Optional[str] = Field(default=None, env="JWT_PRIVATE_KEY_BASE64")
