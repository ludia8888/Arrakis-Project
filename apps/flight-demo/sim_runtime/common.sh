...
: "${ARRAKIS_FLIGHTGEAR_AIRCRAFT_DIR:=$ARRAKIS_ARDUPILOT_DIR/Tools/autotest/aircraft}"
...
runtime_print_summary() {
  ...
  echo "[sim-runtime] FLIGHTGEAR_AIRCRAFT=$ARRAKIS_FLIGHTGEAR_AIRCRAFT"
  echo "[sim-runtime] FLIGHTGEAR_AIRCRAFT_DIR=$ARRAKIS_FLIGHTGEAR_AIRCRAFT_DIR"
  echo "[sim-runtime] FLIGHTGEAR_NATIVE_FDM_PORT=$ARRAKIS_FLIGHTGEAR_NATIVE_FDM_PORT"
  echo "[sim-runtime] FLIGHTGEAR_AIRPORT=$ARRAKIS_FLIGHTGEAR_AIRPORT"
  echo "[sim-runtime] FLIGHTGEAR_GEOMETRY=$ARRAKIS_FLIGHTGEAR_GEOMETRY"
  echo "[sim-runtime] FLIGHTGEAR_DISABLE_SPLASH=$ARRAKIS_FLIGHTGEAR_DISABLE_SPLASH"
