...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--name", type=str, default="yolo26s-trainval", help="Ultralytics run name.")
    parser.add_argument("--epochs", type=int, default=50, help="Training epochs.")
    parser.add_argument("--imgsz", type=int, default=960, help="Training image size.")
    parser.add_argument("--batch", type=int, default=8, help="Batch size.")
    parser.add_argument("--workers", type=int, default=8, help="Dataloader workers.")
    parser.add_argument("--device", type=str, default="0", help="Kaggle GPU device id, e.g. 0.")
