...
class EmbeddingServicer(pb2_grpc.EmbeddingServiceServicer):
    ...
    async def GenerateEmbedding(
        self, request: pb2.EmbeddingRequest, context: grpc.aio.ServicerContext
    ...
    async def GenerateBatchEmbeddings(
        self, request: pb2.BatchEmbeddingRequest, context: grpc.aio.ServicerContext
    ) -> pb2.BatchEmbeddingResponse:
        ...
        try:
            ...
            for embedding in embeddings:
                if isinstance(embedding, np.ndarray):
                    embedding = embedding.tolist()
                results.append(pb2.EmbeddingResult(embedding=embedding, success=True))
    ...
    async def CalculateSimilarity(
        self, request: pb2.SimilarityRequest, context: grpc.aio.ServicerContext
    ) -> pb2.SimilarityResponse:
        ...
        try:
            ...
            similarity = await self.service.calculate_similarity(
                embedding1, embedding2, metric=request.metric or "cosine"
            )

            return pb2.SimilarityResponse(
                similarity=float(similarity), metric_used=request.metric or "cosine"
            )
        except Exception as e:
    ...
    async def FindSimilar(
        self, request: pb2.SimilarSearchRequest, context: grpc.aio.ServicerContext
    ) -> pb2.SimilarSearchResponse:
    ...
    async def StoreEmbedding(
        self, request: pb2.StoreEmbeddingRequest, context: grpc.aio.ServicerContext
    ) -> pb2.StoreEmbeddingResponse:
        ...
        try:
            ...
            return pb2.StoreEmbeddingResponse(
                ...
                if success
                else "Failed to store embedding",
            )
        except Exception as e:
    ...
    async def HealthCheck(
        ...
        try:
            ...
            return pb2.HealthResponse(healthy=False, details={"error": str(e)})
