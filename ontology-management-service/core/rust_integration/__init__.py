...
class RustDeltaEncoder(RustIntegrationBase):
 ...
 # Python fallback
 from ..versioning.delta_compression import DeltaType, EnhancedDeltaEncoder
...
class RustVectorOps(RustIntegrationBase):
 ...
 self, query_vector: list, document_vectors: list
 ) -> list:
...
class RustPerformanceMonitor:
 ...
 rust_percentage = (
 self.metrics["rust_calls"] / total_calls * 100 if total_calls > 0 else 0
 )
