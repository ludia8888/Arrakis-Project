...
class DocumentQueries:
 ...
 @strawberry.field
 async def get_unfoldable_paths(self, content: strawberry.scalars.JSON) -> List[UnfoldableFieldInfo]:
 """
 ...
 @strawberry.field
 async def generate_documentation(self, input: GenerateDocumentationInput) -> GeneratedDocumentation:
 """
...
class DocumentMutations:
 ...
 @strawberry.mutation
 async def prepare_unfoldable(self, input: PrepareUnfoldableInput) -> PreparedDocument:
 """
 ...
 @strawberry.mutation
 async def auto_mark_unfoldable(self, input: AutoMarkUnfoldableInput) -> PreparedDocument:
 """
 ...
 @strawberry.mutation
 async def extract_unfoldable_content(self, content: strawberry.scalars.JSON) -> strawberry.scalars.JSON:
 """
 Extract unfoldable content from a document
 """
 try:
 main_doc, unfoldable_content = UnfoldableProcessor.extract_unfoldable_content(content)
 ...
 @strawberry.mutation
 async def batch_unfold_documents(self, input: BatchUnfoldInput) -> List[UnfoldedDocument]:
 """
 ...
 import asyncio
 tasks = [
 self.unfold_document(doc_input)
