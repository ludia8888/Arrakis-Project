...
Content"""
 ...
 # Audit functionality moved to separate Audit Service
 ]
...
"""
 ...
 # 전체 결론
 overall_success = (
 (working_modules + working_classes + working_async)
 / (total_modules + total_classes + total_async)
 * 100
 )
...
async def main():
 ...
 print(
 f" - 모듈 동작률: {working_modules}/{total_modules} ({working_modules/total_modules*100:.1f}%)"
 )
