...
import grpc
from cloudevents.http import CloudEvent, from_dict, to_dict
from google.protobuf import struct_pb2, timestamp_pb2

logger = logging.getLogger(__name__)

# Production imports - proto stubs must be available
from shared.proto_stubs import event_gateway_pb2, event_gateway_pb2_grpc
...
class EventGatewayClient:
 ...
 event = cloud_event_proto, stream = stream, headers = headers or {}
 )
 ...
 events = cloud_events_proto, stream = stream, headers = headers or {}
 )
 ...
 request = event_gateway_pb2.SubscribeRequest(
 consumer_id = consumer_id, stream = stream, deliver_new = True
 )
 ...
 event_types = event_types or [], enabled_only = enabled_only
 )
 ...
 ] = webhook_proto.stats.last_delivery_status
