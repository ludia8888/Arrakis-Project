...
def check_dependencies():
    ...
    try:
        ...
        print(f"{RED}✗ Redis CLI not found{RESET}")
        return False
...
def setup_graphql_module():
    ...
    oms_dir = Path("/Users/isihyeon/Desktop/Arrakis-Project/ontology-management-service")
...
def start_graphql_services():
    ...
    if not check_dependencies():
        print(f"{RED}Dependencies check failed. Please install required services.{RESET}")
        return
