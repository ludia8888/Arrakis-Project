...
class BackupValidator:
        ...
        for job in backup_jobs:
            ...
            if state == 'COMPLETED':
                ...
                validation_results['failed_job_details'].append({
                    ...
                    'creation_date': job.get('CreationDate', '').isoformat() if job.get('CreationDate') else ''
                })
    ...
    def validate_recovery_points(self, recovery_points: List[Dict[str, Any]]) -> Dict[str, Any]:
...
"""
        ...
        message += f"\nFor detailed information, check CloudWatch Logs for function: {PROJECT_NAME}-backup-validator-{ENVIRONMENT}"
...
def lambda_handler(event, context):
    ...
    try:
        ...
        report = validator.generate_report(backup_validation, recovery_validation, compliance_check)
