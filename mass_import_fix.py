...
def fix_common_logging_imports(file_path):
    ...
    try:
        ...
        patterns = [
            (r'from common_logging\.setup import get_logger', 'from arrakis_common import get_logger'),
            (r'from arrakis_common import get_logger', 'from arrakis_common import get_logger'),
