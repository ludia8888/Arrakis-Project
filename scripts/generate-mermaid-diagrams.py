...
graph TB
    ...
    class OMS,UserSvc,AuditSvc,DataKernel,EmbeddingSvc,SchedulerSvc,
        EventGateway serviceClass
...
graph TD
    ...
    class GitHubActions,CodeQuality,UnitTests,Build,SecurityScan,IntegrationTests,
        TerraformValidation,K8sValidation cicdClass
    class Deploy,Validation,HealthChecks,MonitoringSetup,DocUpdate,DiagramGen,
        DocCommit deployClass
...
graph TB
    ...
    class TLS,DataInTransit,KMS,DataAtRest,SecretsManager,CredentialRotation,
        DatabaseEncryption,VolumeEncryption,BackupEncryption dataClass
    class GuardDuty,ThreatDetection,SecurityHub,CentralizedSecurity,Config,
        ComplianceMonitoring,AutoResponse,SecurityAlerts threatClass
    class CloudTrail,APILogging,AuditLogs,ComplianceDB,VPCFlowLogs,NetworkMonitoring,
        SOC2,PCI,GDPR auditClass
    class SIEM,SecurityMetrics,Splunk,LogAnalysis,Prometheus,SecurityAlerts2,Dashboards,
        ThreatHunting,IncidentResponse monitorClass
    class ImageScanning,ECR,PodSecurityPolicies,K8s,NetworkPolicies,Istio,TrustedImages,
        SecureDeployments,mTLS containerClass
"""
...
def generate_all_diagrams():
    ...
    diagrams = {
        ...
        "cicd-flow.md": {"title": "CI/CD Flow", "diagram": create_cicd_flow_diagram()},
...
<head>
    ...
    <style>
        ...
        .diagram-card { background: white; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,

            0,0,0.1); margin: 20px 0; padding: 20px; }
