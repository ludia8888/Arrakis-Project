...
# Setup logger early for import section
import logging
...
try:
    ...
    logger.warning("Protobuf files not found. Run 'protoc --python_out=. --grpc_python_out=. *.proto' to generate them.")
